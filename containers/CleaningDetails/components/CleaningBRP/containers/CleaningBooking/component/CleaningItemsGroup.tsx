...
const cleaningItems: CleaningItemGroup[] = [
...
export const CleaningItemsGroup: React.FC = () => {
  // Initialize state with the QuantityState type
  const [quantities, setQuantities] = useState<QuantityState>(
    cleaningItems.reduce((acc, group) => {
